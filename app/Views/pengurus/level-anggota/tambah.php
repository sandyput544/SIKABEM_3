...
<div class="row g-3 d-flex">
  <div class="col-12">
    <a href="/pengurus/level-anggota" class="btn btn-secondary rounded-3"><i class="bi-arrow-left"></i><span>Kembali</span></a>
  </div>
  <div class="col-12 col-sm-6 align-items-center">
    <form action="/pengurus/level-anggota/save" method="POST">
      <?= csrf_field(); ?>
        ...
        <div class="card-body">
          <div class="row g-3">
            <div class="col-12 col-md-6">
              ...
              <select class="form-select" id="selectDept" name="dept_id">
                ...
                <?php foreach ($departments as $d) : ?>
                  <option value="<?= $d['dept_id']; ?>" <?= (old('dept_id') == $d['dept_id']) ? 'selected' : ''; ?>><?= $d['dept_name']; ?></option>
                <?php endforeach; ?>
              </select>
            ...
            <div class="col-12 col-md-6">
              ...
              <input type="text" class="form-control" id="inputMemberLevelSeats" name="memberlevel_seats" value="<?= old('memberlevel_seats'); ?>">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" id="inputMemberLevel" name="memberlevel_name" value="<?= old('memberlevel_name'); ?>">
