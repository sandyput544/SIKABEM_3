...
<div class="row g-3">
  ...
  <div class="col-6">
    <form action="/pengurus/menu/save" method="POST" enctype="multipart/form-data">
      <?= csrf_field(); ?>
            ...
            <div class="col-12">
              <div class="row g-3">
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="inputMenu" placeholder="Menu atau Dashboard" name="title" value="<?= old('title'); ?>" autofocus>
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="inputUrl" placeholder="menu atau kritik-saran" name="url" value="<?= old('url'); ?>">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="inputIcon" placeholder="bi-diagram-3-fill" name="icon" value="<?= old('icon'); ?>">
