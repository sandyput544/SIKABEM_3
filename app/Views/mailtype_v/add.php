...
<div class="row g-3">
  ...
  <div class="col-6">
    <form action="<?= base_url('surat/jenis/save'); ?>" method="POST">
      <?= csrf_field(); ?>
            ...
            <div class="col-12">
              <div class="row g-3">
                <div class="col-12">
                  ...
                  <input type="text" class="form-control" id="inputName" placeholder="Surat Keputusan" name="nama_jenis" value="<?= old('nama_jenis'); ?>" autofocus>
                  <?= showError('nama_jenis'); ?>
                </div>
                <div class="col-12">
                  <label for="inputCode" class="form-label">Kode Surat</label>
                  <input type="text" class="form-control" id="inputCode" placeholder="SK" name="kode_surat" value="<?= old('kode_surat'); ?>">
