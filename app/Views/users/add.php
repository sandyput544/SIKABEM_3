        ...
        <div class="card-body">
          <div class="row g-3">
            <div class="col-12">
              ...
              <input type="text" name="nama_user" placeholder="Contoh: Armand Maumandi" id="nama_user" class="form-control" value="<?= old('nama_user'); ?>" autofocus>
              <?= showError('nama_user'); ?>
            </div>
            <div class="col-12">
            ...
            <div class="col-12">
              <label for="phoneInput" class="form-label">Nomor Ponsel</label>
