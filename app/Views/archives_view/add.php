                ...
                <div class="col-12">
                  <div class="row g-3">
                    <div class="col-12">
                      ...
                      <input type="text" class="form-control" id="inputName" placeholder="Anggaran Dasar Aturan Rumah Tangga 2020" name="archive_name" value="<?= old('archive_name'); ?>" autofocus>
                    ...
                    <div class="col-12">
                      ...
                      <select class="form-select" id="selectCategory" name="cat_id">
                        <?php foreach ($categories as $c) : ?>
                          <option value="<?= $c['id']; ?>" <?php (old('cat_id', $c['id'])) ? 'selected' : ''; ?>><?= $c['cat_name']; ?></option>
                        <?php endforeach; ?>
                      </select>
                      <?= showError('cat_id'); ?>
                    </div>
