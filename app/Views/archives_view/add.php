                ...
                <div class="col-12">
                  <div class="row g-3">
                    <div class="col-6">
                      ...
                      <select class="form-select" id="selectCategory" name="kd_kategori">
                        <?php foreach ($categories as $c) : ?>
                          <option value="<?= $c['kd_kategori']; ?>" <?= (old('kd_kategori')) ? 'selected' : ''; ?>><?= $c['nama_kat']; ?></option>
                        <?php endforeach; ?>
                      </select>
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" class="form-control" id="inputName" placeholder="Anggaran Dasar Aturan Rumah Tangga 2020" name="nama_arsip" value="<?= old('nama_arsip'); ?>">
                      <?= showError('nama_arsip'); ?>
                    </div>
                    <div class="col-6">
                      <label for="inputDate" class="form-label">Tanggal Buat</label>
                      <input type="text" class="form-control" id="inputDate" name="tgl_buat" value="<?= old('tgl_buat'); ?>">
                      <?= showError('tgl_buat'); ?>
                    </div>
                    <div class="col-6">
                      <label for="inputCreator" class="form-label">Nama Pembuat</label>
                      <input type="text" class="form-control" id="inputCreator" placeholder="Nama lengkap seseorang" name="nama_pembuat" value="<?= old('nama_pembuat'); ?>">
